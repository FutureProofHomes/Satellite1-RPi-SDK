...
def jack_plugged_frames(color: LedColorRGB, *, frame_interval: float) -> LedAnimation:
...
def jack_unplugged_frames(color: LedColorRGB, *, frame_interval: float) -> LedAnimation:
...
def _symmetric_frame(first: int, second: int, color: LedColorRGB) -> LedFrame:
